...
function load_game_data.command_description(command_code)
  command_code_description = {
    ...
    "Clears BitFlag 0",
    "Refills lamp (?)",
    "Clears screen. This varies by interpreter from no effect upwards",
    "Saves the game. Choices of filename etc depend on the interpreter alone",
    ...
    "Prints current counter value. Some interpreters only cope with 0-99 apparently",
